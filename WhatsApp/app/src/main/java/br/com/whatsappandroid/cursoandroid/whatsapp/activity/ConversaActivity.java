...
public class ConversaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Bundle extra = getIntent().getExtras(); // Bundle é utilizado para passar dados entre uma activity e outra
        ...
        valueEventListenerMensagem = new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                adapter.notifyDataSetChanged(); // Notificar que os dados mudaram
        ...
        btMensagem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if( textoMensagem.isEmpty() ){
                    ...
                    Boolean retornoConversaRemetente = salvarConversa( idUsuarioRemetente, idUsuarioRemetente, conversa);

                    if ( !retornoConversaRemetente ){
                        Toast.makeText(ConversaActivity.this, "Problema ao salvar conversa, tente novamente!", Toast.LENGTH_LONG).show();

                    }else{
                        // Salvamos a conversa para o destinatário
