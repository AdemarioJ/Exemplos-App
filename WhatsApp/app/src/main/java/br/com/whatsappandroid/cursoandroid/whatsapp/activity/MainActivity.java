...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setSupportActionBar(toolbar); // Método de suporte para que a toolbar funcione corretamente
        ...
        TabAdapter tabAdapter = new TabAdapter( getSupportFragmentManager() ); // Passado no parametro o objeto que dara suporte e gerencia os fragmentos
    ...
    @Override
    public boolean onCreateOptionsMenu(Menu menu) { // Inflater é usado para inflar os menus ou exibir os menus na tela
        MenuInflater inflater = getMenuInflater(); // método getMenuInflater, ele cria um obejto do tipo inflater já com o contexto da aplicação
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch ( item.getItemId() ){
            ...
            case R.id.item_adicionar:
                ...
                return true;
            default: // Boa pratica deixar o super como default aqui
